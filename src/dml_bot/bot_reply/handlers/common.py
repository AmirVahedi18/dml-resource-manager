...
HELP_TEXT_ADMIN = (
    ...
    "chart of usage. Or pick 📅 Historical Availability, then a GPU, a start date (YYYY-MM-DD), "
    "and how many days forward to show, to get that GPU's availability chart (same renderer as "
    "🗓 Schedule) for any past window — reservations are kept forever, so this works no matter how "
    "long ago.\n\n"
