...
import type { GpuOut, ServerOverviewOut } from '../api/types'
...
export function AvailabilityGlance({ selectedGpuId, onPick, reloadSignal = 0 }: Props) {
    ...
    <div className="card card-feature">
      ...
      {servers && servers.length > 0 && (
        <p className="muted glance-hint">
          <FontAwesomeIcon icon={faRotate} /> Pick a GPU to jump to the booking form.
        </p>
      )}
    </div>
  )
